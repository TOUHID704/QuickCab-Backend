...
INSERT INTO driver (user_id, rating, available, current_location) VALUES
  ...
  (11, 4.8, true, ST_GeomFromText('POINT(77.2400 28.6900)', 4326)),
  (12, 4.5, true, ST_GeomFromText('POINT(77.2100 28.7100)', 4326)),
  (13, 4.3, true, ST_GeomFromText('POINT(77.2300 28.7300)', 4326)),
  (14, 4.7, true, ST_GeomFromText('POINT(77.2900 28.7500)', 4326)),
  (15, 4.6, true, ST_GeomFromText('POINT(77.2600 28.7300)', 4326)),
  (16, 4.8, true, ST_GeomFromText('POINT(77.2800 28.7100)', 4326)),
  (17, 4.5, true, ST_GeomFromText('POINT(77.2700 28.7400)', 4326)),
  (18, 4.9, true, ST_GeomFromText('POINT(77.3000 28.7600)', 4326)),
  (19, 4.4, true, ST_GeomFromText('POINT(77.2200 28.6600)', 4326)),
  (20, 4.8, true, ST_GeomFromText('POINT(77.2100 28.6400)', 4326)),
  (21, 4.6, true, ST_GeomFromText('POINT(77.2000 28.6500)', 4326)),
  (22, 4.3, true, ST_GeomFromText('POINT(77.2500 28.6800)', 4326)),
  (23, 4.7, true, ST_GeomFromText('POINT(77.2300 28.7100)', 4326)),
  (24, 4.8, true, ST_GeomFromText('POINT(77.2600 28.6500)', 4326)),
  (25, 4.5, true, ST_GeomFromText('POINT(77.2800 28.6900)', 4326)),
  (26, 4.9, true, ST_GeomFromText('POINT(77.2400 28.6700)', 4326)),
  (27, 4.6, true, ST_GeomFromText('POINT(77.2300 28.6800)', 4326)),
  (28, 4.7, true, ST_GeomFromText('POINT(77.2100 28.6600)', 4326)),
  (29, 4.3, true, ST_GeomFromText('POINT(77.2900 28.6800)', 4326)),
  (30, 4.6, true, ST_GeomFromText('POINT(77.2600 28.6700)', 4326)),
  (31, 4.5, true, ST_GeomFromText('POINT(77.2200 28.6600)', 4326)),
  (32, 4.7, true, ST_GeomFromText('POINT(77.2300 28.6400)', 4326)),
  (33, 4.4, true, ST_GeomFromText('POINT(77.2400 28.6800)', 4326)),
  (34, 4.8, true, ST_GeomFromText('POINT(77.2500 28.6900)', 4326)),
  (35, 4.7, true, ST_GeomFromText('POINT(77.2700 28.7100)', 4326)),
  (36, 4.5, true, ST_GeomFromText('POINT(77.2800 28.6700)', 4326)),
  (37, 4.6, true, ST_GeomFromText('POINT(77.2100 28.7000)', 4326)),
  (38, 4.3, true, ST_GeomFromText('POINT(77.2300 28.7100)', 4326)),
  (39, 4.9, true, ST_GeomFromText('POINT(77.2400 28.7400)', 4326)),
  (40, 4.8, true, ST_GeomFromText('POINT(77.2500 28.7500)', 4326));
